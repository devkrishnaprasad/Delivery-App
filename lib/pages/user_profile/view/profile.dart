...
import 'package:delivery_app/pages/user_profile/controller/api/user_api.dart';
...
class _UserProfileState extends State<UserProfile> {
  ...
  void initState() {
    ...
    if (_homeController.usersDetails.isNotEmpty) {
                    ...
                    CircleAvatar(
                      ...
                      child: ClipOval(
                        child: _image != null
                            ...
                            : _homeController.usersDetails.isEmpty
                                ? const CircleAvatar(
                                    radius: 100,
            ...
            children: [
              ...
              Padding(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    value: _homeController.usersDetails.isEmpty
                        ? 'Male'
                        : _homeController.usersDetails[0].gender,
                    items: genderList
